$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            // Event start date
            start: new Date('Sept 14, 2019 04:00'),
            ...
            end: new Date('Sept 15, 2019 00:00'),

            // Event Address
            address: '18501 Bear Creek Rd, Los Gatos, CA 95033',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues contact Patrick at (408) 761-8374."
        }
    });
...
// Google map
function initMap() {
    var itc_kol = {lat: 37.1896567, lng: -121.9951621};
...
function initBBSRMap() {
    var la_fiesta = {lat: 37.1896567, lng: -121.9951621};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
